...
MAINTAINER "Rita Zhang" "rita.z.zhang@gmail.com"
...
# start JBoss
ENTRYPOINT $JBOSS_HOME/bin/standalone.sh -c myjboss.xml
#standalone-full-ha.xml
#myjboss.xml

# deploy app
ADD jboss-as-helloworld.war "$JBOSS_HOME/standalone/deployments/"
#ADD liquidacion-ear.ear "$JBOSS_HOME/standalone/deployments/"
